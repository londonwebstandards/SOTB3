<div id="sponsors" class="four columns offset-by-one">
    <h2>Sponsors</h2>
    <ul>
        <li><a class="logo" href="http://modern.ie" target="blank"><img src="img/IE_rgb_Cyan_2_D_rgb.png" alt="Internet Explorer" width="160"></a></li>
        <li><a class="logo" href="http://squiz.net/uk" target="blank"><img src="img/Squiz-notag-jpeg" alt="Squiz" height="60" width="160"></a></li>
