...
<?php include("inc/navigation.php"); ?>
    ...
    <div class="eleven columns">
        <div id="lastyearpicsvideo">
            <p>Last year we had 140 web professionals attending our conference.</p>
            <p>We had all the browser advocates (except for Apple, but we did have an apple on the panel) presenting new and upcoming features in their browser and taking part in a panel moderated by Michael Mahemoff.</p>
            <p>They also hosted a breakout session and were joined by other experts like Seb Lee-Deslie, Jason Grant and Pete Gasston.</p>

            <div id="presenters" class="home">
                <h2>Last year's presenters included…</h2>
                <ul>
                    <li>
            ...
            <h2 style="clear:both;">The Panel</h2>
            ...
            <br />More videos from SOTB2 on <a href="http://vimeo.com">Vimeo</a>.</p>
