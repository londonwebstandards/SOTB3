        ...
        <div id="presenters">
            <ul>
                ...
                <li>
                    ...
                    <p>Developer Advocate at Google on Chrome. Mobile BadAss. Mr Web Intents. Developer of many techie things including Twollo, Twe2, Topicala, Ahoyo and FriendDeck.</p>
                </li>
                ...
                <li>
					...
					<p>Andreas has been with Opera since 2007: first as QA engineer and web evangelist in Tokyo, then as group leader Developer Relations working from Opera's Oslo HQ. In February he became Product Manager for Opera Extensions, and a member of Opera's Web Standards group.</p>
                </li>

                <li>
                    <h2>Making your HTML5 efforts worthwhile<h2>
                ...
                <li>
                    <h2>Can you change the world through the browser? The truth about building a social impact MVP</h2>
                    ...
                    <p>Priya is founder of Design for Social Change (D4SC), a win-win social impact business for communities, local business and global brands. D4SC marries realtime citizen data with grassroots action through Changify, its mobile crowd intelligence platform for creating better neighbourhoods.</p>

                    <p>She has 12 years hands-on strategic digital product design and leadership experience responsible for creating market leading products with unique IP for household brands e.g. BBC iPlayer – No.1 brand in UK and Nokia Asha Smart Phones commanding 35% market share in Asia. Her designs have boosted share value by 18%, created valuable online properties and paved way for successful start up exits worth over millions. She is an invited speaker at SXSW, O’Reilly ETech, MEX, TEDx, Apple Computers Inc , 2013 D&AD judge and tutor at UCL’s Mobile Academy.</p>
